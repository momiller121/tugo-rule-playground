...
const TuGoRoute = require('./routes/tugo-rule');
...
const AwesomeProduct = class {
    ...
    constructor(options = {}) {
        ...
        this.swaggerOptions = {
            schemes: ['https','http'],
            info: {
                title: 'TuGo Eligibility Playground',
                version: Pack.version,
                description: `## Exploring TuGo Eligibility Rule Implementation

---

*** DEMONSTRATION PURPOSES ONLY - NOT FOR BUSINESS USE

We're using this as a rapid prototype to clarify acceptance criteria for the TuGo Eligibility resource.
                `
            }
        };
    }
